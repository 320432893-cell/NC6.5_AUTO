...
_.finished_at  # unused attribute (core/receipt_detail_async_verifier.py:38)
_.finished_at  # unused attribute (core/receipt_detail_async_verifier.py:193)
BUSINESS_TYPE_COL  # unused variable (core/receipt_detail_fields.py:128)
read_first_row_cells  # unused function (core/receipt_detail_reader.py:62)
get_cell_context  # unused function (core/receipt_detail_screen_writer.py:54)
find_query_condition_scope_path_only  # unused function (core/receipt_query_dynamic_fields.py:69)
field_cfg  # unused variable (core/receipt_query_fill.py:110)
get_window_pid  # unused function (core/receipt_self_made_fill_trial.py:1324)
foreground_root_hwnd  # unused function (core/receipt_self_made_fill_trial.py:2416)
